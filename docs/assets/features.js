...
|Plain header |No colour emphasis
|===

[pros-cons pro-icon="YES" con-icon="NO"]
|===
|Avoid |Prefer
...
ifndef::missing[Inline shown]`,
  ...
  },
  {
    ...
    title: "Button object",
    group: "document",
    desc: "The button macro renders a styled link with modern button classes and color variants.",
    source: `{{button:download text="Download now" href=/download color=primary}} {{button:read-more color=secondary}} {{button:external text=Docs href=https://example.com target=_blank}}`,
    expected: `<div class="remarkd-section section--level0 section--with-content"><a href="/download" class="btn btn--primary">Download now</a> <a href="#read-more" class="btn btn--secondary">Read More</a> <a href="https://example.com" class="btn btn--gray" target="_blank">Docs</a></div>`,
  },
  {
    slug: "reference-list",
    title: "References",
